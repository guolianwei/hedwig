...
public class HiveDRStatusStore extends DRStatusStore {
    ...
    private static final String DEFAULT_STORE_PATH = StringUtils.removeEnd(
            DRStatusStore.BASE_DEFAULT_STORE_PATH, FileUtils.HDFS_SEP) + FileUtils.HDFS_SEP
            + "hiveReplicationStatusStore" + FileUtils.HDFS_SEP;
    ...
    public void checkForReplicationConflict(String newSource, String jobName,
        ...
        try {
            Path globPath = new Path(getStatusDbDirPath(database), "*" + FileUtils.HDFS_SEP + "latest.json");
