...
import com.meritdata.hn.falcon.hive.util.*;
import org.apache.commons.cli.ParseException;
import org.apache.commons.io.IOUtils;
import org.apache.commons.lang3.StringUtils;
import com.meritdata.hn.falcon.hive.exception.HiveReplicationException;
import com.meritdata.hn.falcon.hive.mapreduce.CopyMapper;
import com.meritdata.hn.falcon.hive.mapreduce.CopyReducer;
import com.meritdata.hn.falcon.hive.util.*;
...
import static com.meritdata.hn.falcon.hive.util.FileUtils.HDFS_SEP;
...
public class HiveDRTool extends Configured implements Tool {
    ...
    public Job execute() throws Exception {
        ...
        String name = HiveDRUtils.ExecutionStage.LASTEVENTS.name();
        if (name.equalsIgnoreCase(executionStage)) {
            String lastEventsIdFile = getLastEvents(jobConf);
            LOG.info("Last successfully replicated Event file : {}", lastEventsIdFile);
            return null;
        } else if (HiveDRUtils.ExecutionStage.EXPORT.name().equalsIgnoreCase(executionStage)) {
        ...
        } else if (HiveDRUtils.ExecutionStage.IMPORT.name().equalsIgnoreCase(executionStage)) {
    ...
    private String sourceEvents() throws Exception {
        ...
        try {
            ...
            throw new Exception(e.getMessage() + ";source : " + inputOptions.getSourceMetastoreUri(), e);
        } finally {
    ...
    private Map<String, Long> getLastDBTableEvents(Path lastEventIdFile) throws Exception {
        ...
        try  {
            ...
            throw new IOException(e.getMessage() + ";FS : " + jobFS.getUri(), e);
        } finally {
