...
public final class FileUtils {
    public static  final String HDFS_SEP="/";
    public static final String DEFAULT_EVENT_STORE_PATH = StringUtils.removeEnd(DRStatusStore
            .BASE_DEFAULT_STORE_PATH, HDFS_SEP) + HDFS_SEP + "Events" + HDFS_SEP;
    ...
    public static void validatePath(final FileSystem fileSystem, final Path basePath) throws IOException {
        ...
        //777权限直接验证成功
        if (fileSystem.getFileStatus(basePath).getPermission().equals(DRStatusStore.DEFAULT_STORE_PERMISSION_ALL)) {
            return;
        }
